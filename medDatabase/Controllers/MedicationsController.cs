...
namespace medDatabase.Controllers
{
    public class MedicationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DosageMgPerLbBodyWeight")] Medication medication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DosageMgPerLbBodyWeight")] Medication medication)
        {
            if (ModelState.IsValid)
            {
